...
create table projects (id bigint generated by default as identity, created_at timestamp, description varchar(255), name varchar(255), updated_at timestamp, primary key (id));
