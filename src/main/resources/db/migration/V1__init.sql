create table notifications (id bigint generated by default as identity, created_at timestamp default current_timestamp, message varchar(1500), title varchar(100), updated_at timestamp default current_timestamp, task_id bigint, user_id bigint, primary key (id));
...
create table tasks (id bigint generated by default as identity, archived boolean, created_at timestamp default current_timestamp, deadline_time timestamp, description varchar(500), name varchar(100), updated_at timestamp default current_timestamp, project_id bigint, task_state_id bigint, primary key (id));
