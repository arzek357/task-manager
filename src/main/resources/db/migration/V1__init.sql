...
drop table if exists tasksauthorities CASCADE ;
drop table if exists taskstates CASCADE ;
drop table if exists users CASCADE ;
drop table if exists users_notifications CASCADE ;
drop table if exists users_projects CASCADE ;
drop table if exists users_roles CASCADE ;
create table notifications (id bigint generated by default as identity, created_at timestamp default current_timestamp, message varchar(1500), title varchar(100), updated_at timestamp default current_timestamp, task_id bigint, primary key (id));
create table projects (id bigint generated by default as identity, created_at timestamp default current_timestamp, description varchar(255), name varchar(255) not null, updated_at timestamp default current_timestamp, creator_id bigint not null, primary key (id));
...
create table taskparticipants (id bigint generated by default as identity, task_id bigint, task_authority_id bigint, user_id bigint, primary key (id));
create table tasks (id bigint generated by default as identity, archived boolean, created_at timestamp default current_timestamp, deadline_time timestamp, description varchar(500), name varchar(100) not null, updated_at timestamp default current_timestamp, project_id bigint, task_state_id bigint, primary key (id));
